...
<html itemscope itemtype="http://schema.org/WebPage">
    ...
    <body >
        <nav class="navbar navbar-inverse navbar-fixed-top">
            <div class="container" >
                <h1 class='white'  itemprop="headline" itemscope  itemtype="http://schema.org/Text">All ${bank}   Banks in ${state} Ifsc Codes.</h1>
            </div>
        </nav>
        ...
        <div class='col-lg-10 col-md-12 col-sm-12 col-xs-12'>
            <div class="panel panel-default margin-top">
                <div class="panel-heading">
                    <h2 itemprop='breadcrumb' itemscope itemtype="http://schema.org/Text"><a href="/#!${bank}"> ${bank}  Bank > </a> <a href="/#!${bank}/${state}">${state} ></a>   District  List</h2>
                </div>
